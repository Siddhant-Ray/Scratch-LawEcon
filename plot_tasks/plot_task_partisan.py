    ...
    if i != 0 and i != 1:
        ...
        if i % 18 == 0:
            ...
            act_axis.annotate(
                annotation_text,
                (xcoords[i], ycoords[i]),
                (xcoords[i] - 0.20, ycoords[i] + 0.015),
                arrowprops=dict(arrowstyle="->", connectionstyle="arc3"),
            )
        elif i % 8 == 0:
            act_axis.annotate(
