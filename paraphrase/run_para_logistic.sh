...
bsub "${args[@]}" python paraphrase/dataloader_testcorpus.py --device cpu --threshold 0.39
...
# bsub "${args[@]}" -oo paraphrase/outputfiles/logistic_test.out python paraphrase/logistic_test.py --file full --th 0.00
